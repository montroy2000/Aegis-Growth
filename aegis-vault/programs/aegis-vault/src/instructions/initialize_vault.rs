...
pub struct InitializeVault<'info> {
    ...
    pub switchboard_usdc_feed: AccountInfo<'info>,
...
pub fn handler(
    ...
    require!(max_leverage_bps <= 20000, ErrorCode::InvalidLeverage); // Max 2.0x
    require!(hf_floor_bps >= 10000, ErrorCode::InvalidHealthFactor); // Min 1.0
    ...
    vault.switchboard_usdc_feed = ctx.accounts.switchboard_usdc_feed.key();
    ...
    msg!("Vault initialized with max leverage: {}bps, HF floor: {}bps", 
        max_leverage_bps, hf_floor_bps);
